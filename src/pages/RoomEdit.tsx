...
import { Music, Upload, X, DollarSign, Save, ArrowLeft, Clock } from 'lucide-react';
...
const US_TIMEZONES = [
  { name: 'Eastern Time (ET)', value: 'America/New_York', offset: 'UTC-5/UTC-4' },
  { name: 'Central Time (CT)', value: 'America/Chicago', offset: 'UTC-6/UTC-5' },
  { name: 'Mountain Time (MT)', value: 'America/Denver', offset: 'UTC-7/UTC-6' },
  { name: 'Pacific Time (PT)', value: 'America/Los_Angeles', offset: 'UTC-8/UTC-7' },
  { name: 'Alaska Time (AKT)', value: 'America/Anchorage', offset: 'UTC-9/UTC-8' },
  { name: 'Hawaii-Aleutian Time (HST)', value: 'Pacific/Honolulu', offset: 'UTC-10' },
  { name: 'Arizona Time (MST)', value: 'America/Phoenix', offset: 'UTC-7' },
  { name: 'Atlantic Time (AST)', value: 'America/Halifax', offset: 'UTC-4/UTC-3' },
  { name: 'Chamorro Time (ChST)', value: 'Pacific/Guam', offset: 'UTC+10' },
];
    ...
    async function loadData() {
      ...
      try {
        ...
        setFormValues({
          ...
          timezone: roomData.timezone || 'America/New_York' // Default to Eastern Time if not set
        });
      } catch (err) {
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-6 bg-white rounded-lg shadow-sm p-6">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            This timezone will be used for all availability and booking times
          </p>
        </div>
